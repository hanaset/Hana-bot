package com.hanaset.hanabot.common.config
...
@ComponentScan(basePackages = [
    "com.hanaset.hanabot.common.repository"
])
@EnableJpaRepositories(
        basePackages = ["com.hanaset.hanabot.common.repository"],
...
class HanaJpaDatabaseConfig(private val mbeanExporter: MBeanExporter) {
    ...
    @Bean
    @Primary
    @ConfigurationProperties(prefix = "hanabot.jpa")
    ...
    fun hanaEntityManagerFactory(builder: EntityManagerFactoryBuilder): LocalContainerEntityManagerFactoryBean {
        return builder
                ...
                .packages("com.hanaset.hanabot.common.entity")
